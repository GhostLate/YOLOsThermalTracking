...
if str(ROOT / 'YOLOU') not in sys.path:
    sys.path.append(str(ROOT / 'YOLOU'))  # add yolov5 ROOT to PATH

ROOT = Path(os.path.relpath(ROOT, Path.cwd()))  # relative

import logging
from YOLOU.utils.torch_utils import select_device
from YOLOU.models.common import DetectMultiBackend
from YOLOU.utils.general import LOGGER, colorstr, check_requirements, check_version
