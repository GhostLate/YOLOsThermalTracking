...
from yolos_thermal_tracking.YOLOU.utils.general import xyxy2xywh
...
class StrongSORT:
    def __init__(self,
        ...
        self.tracker = Tracker(
            ...
            max_unmatched_preds=max_unmatched_preds, mc_lambda=mc_lambda, ema_alpha=ema_alpha)
